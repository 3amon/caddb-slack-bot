...
carddb.prototype.parseMessage = function (message)
{
...
carddb.prototype.buildPost = function (card, exactmatch)
{
    var post = {};
    if (!exactmatch)
    {
...
carddb.prototype.findBestNameMatch = function (fuzzyname)
{
    var result = {};
